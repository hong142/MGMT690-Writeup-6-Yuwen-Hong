...
Recall that our pipeline starts from images uploaded by different devices, and the first stage is to validate images and seperate valid and invalid images into different repositories. Then we use valid images and a detection model as inputs to process the object detection stage with json files recording object detected as output under folders of each dievices.
